    ...
    <>
        ...
        <div className="mx-auto flex max-w-7xl items-center gap-2 px-4 py-3 sm:gap-4">
          <div className="flex shrink-0 items-center gap-2">
            ...
            <button
              ...
              className="flex h-7 shrink-0 items-center justify-center gap-1 rounded-lg bg-gray-100 px-2 text-xs font-medium text-gray-500 hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700"
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 pb-32 pt-[calc(env(safe-area-inset-top)+1rem)] lg:flex-row lg:items-start lg:gap-6 lg:pb-5 lg:pt-5">
        ...
        >
          ...
          <div ref={statusTabListRef} className="relative mb-3 grid shrink-0 grid-cols-3 rounded-xl bg-white p-1 shadow-sm dark:bg-[#1a1a1a]">
            {/* 슬라이딩 인디케이터 */}
            <motion.div
      ...
      <div className="fixed inset-x-0 bottom-0 z-50 border-t border-gray-200 bg-white pb-[env(safe-area-inset-bottom)] dark:border-gray-700 dark:bg-[#1a1a1a] lg:hidden">
        <div className="grid h-14 grid-cols-4">
          ...
          >
            ...
            <span className="text-xs font-semibold">{isDarkMode ? '라이트' : '다크'}</span>
          </button>
          <button
