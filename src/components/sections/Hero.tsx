...
export default function Hero({ startAnimation = false }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      {/* Scroll Indicator */}
      <div className="absolute bottom-24 md:bottom-16 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3">
        <span className="text-xs text-white/50 tracking-wide">아래로 스크롤 하세요</span>
