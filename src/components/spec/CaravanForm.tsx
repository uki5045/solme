          ...
          <label className="flex w-fit cursor-pointer items-center gap-3 py-1">
            <div className="relative flex items-center justify-center">
              <input
                ...
                className="peer h-5 w-5 cursor-pointer appearance-none rounded-md bg-gradient-to-b from-white to-gray-50 shadow-[inset_0_0_0_1px_rgba(0,0,0,0.1)] transition-all duration-200 checked:from-accent-500 checked:to-accent-600 hover:from-gray-50 hover:to-gray-100 hover:shadow-[inset_0_0_0_1px_rgba(0,0,0,0.15)] checked:hover:from-accent-400 checked:hover:to-accent-500 active:scale-95 focus:outline-none focus:ring-2 focus:ring-accent-500/20 focus:ring-offset-0 dark:from-[#2a2f3a] dark:to-[#262a33] dark:shadow-[inset_0_0_0_1px_rgba(255,255,255,0.08)] dark:checked:from-emerald-400 dark:checked:to-emerald-500 dark:hover:from-[#2e3340] dark:hover:to-[#282d36] dark:hover:shadow-[inset_0_0_0_1px_rgba(255,255,255,0.12)] dark:checked:hover:from-emerald-300 dark:checked:hover:to-emerald-400"
              />
